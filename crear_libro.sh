...
# Realiza la solicitud POST para crear un libro usando el token JWT
curl -v -X POST -H "Content-Type:application/json" -H "Authorization: Bearer $token" --data "$LIBRO_DATA" $PROTECTED_URL